CREATE DATABASE  IF NOT EXISTS `bbdd_kaos155_borme`; 

USE `bbdd_kaos155_borme`;
-- MySQL dump 10.13  Distrib 8.0.15, for Win64 (x86_64)
--
-- Host: 54.36.118.148    Database: bbdd_kaos155_borme
-- ------------------------------------------------------
...
--
-- Dumping data for table `Workers_suspicius`
--

LOCK TABLES `Workers_suspicius` WRITE;
/*!40000 ALTER TABLE `Workers_suspicius` DISABLE KEYS */;
/*!40000 ALTER TABLE `Workers_suspicius` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `borme_actos` (
  ...
  `Mes` int(11) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `borme_empresas` (
  ...
  `Anyo_constitucion` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Domicilio` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Objeto_Social` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  ...
  `_date_activacion` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`_key`),
  UNIQUE KEY `id` (`_id`),
  KEY `activos` (`_activa`)
) ENGINE=innodb DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `ia_data_contratos`
--

LOCK TABLES `ia_data_contratos` WRITE;
/*!40000 ALTER TABLE `ia_data_contratos` DISABLE KEYS */;
/*!40000 ALTER TABLE `ia_data_contratos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ia_data_seguimiento`
--

LOCK TABLES `ia_data_seguimiento` WRITE;
/*!40000 ALTER TABLE `ia_data_seguimiento` DISABLE KEYS */;
/*!40000 ALTER TABLE `ia_data_seguimiento` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ia_data_suspicius`
--

LOCK TABLES `ia_data_suspicius` WRITE;
/*!40000 ALTER TABLE `ia_data_suspicius` DISABLE KEYS */;
/*!40000 ALTER TABLE `ia_data_suspicius` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ia_data_tree` (
  ...
  `_Nombre` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `_Empresa` tinyint(4) DEFAULT NULL,
  `_trx` int(11) UNSIGNED DEFAULT NULL,
...
--
-- Dumping data for table `ia_data_tree`
--

LOCK TABLES `ia_data_tree` WRITE;
/*!40000 ALTER TABLE `ia_data_tree` DISABLE KEYS */;
/*!40000 ALTER TABLE `ia_data_tree` ENABLE KEYS */;
UNLOCK TABLES;
...
BEGIN
	...
	DECLARE exit handler for SQLEXCEPTION
		...
		SELECT _level,_key,_Nombre, concat(_tree, '\\' ,_Nombre) as _tree,_Empresa,_Financiera,_Auditor, _trx as _score,_path FROM ia_data_suspicius where _path LIKE CONCAT('#',_Tkey,'%') ORDER BY _trx DESC; 
    ...
    SELECT ((UNIX_TIMESTAMP(now())*1000) - _Timex)/1000 as seconds,_contador as nodes,_count_susp as _suspicius,max_nodes,min_Relations;
    SELECT _level,_key,_Nombre, concat(_tree, @b ,_Nombre) as _tree,_Empresa,_Financiera,_Auditor, _trx as _score,_path FROM ia_data_suspicius where _path LIKE CONCAT('#',_Tkey,'%') ORDER BY _trx DESC; 
...
BEGIN
	...
	get_relaciones: LOOP
        ...
        IF NOT _TFinanciera AND NOT _TAuditor AND NOT _Tstop AND _maxnode>=_contador THEN 
...
/*!50001 VIEW `relacionado_con` AS select `ia_data_unique`.`Relation_key` AS `_DKey`,`ia_data_unique`.`Empresa_key` AS `_key`,`_Empresa`.`Nombre` AS `Nombre`,`_Empresa`.`_Empresa` AS `_Empresa`,`_Empresa`.`_Directivo` AS `_Directivo`,`_Empresa`.`_Auditor` AS `_Auditor`,`_Empresa`.`_Financiera` AS `_Financiera`,`_Empresa`.`_Sicav` AS `_Sicav`,`_Empresa`.`_Slp` AS `_Slp`,`_Empresa`.`T_Relations` AS `T_Relations`,`_Empresa`.`ia_suspicius` AS `ia_suspicius` from ((`ia_data_unique` left join `borme_keys` `_Empresa` on((convert(`ia_data_unique`.`Empresa_key` using utf8) = `_Empresa`.`_key`))) left join `borme_keys` `_directivo` on((convert(`ia_data_unique`.`Relation_key` using utf8) = `_directivo`.`_key`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `relaciones_de` AS select `ia_data_unique`.`Empresa_key` AS `_DKey`,`ia_data_unique`.`Relation_key` AS `_key`,`_directivo`.`Nombre` AS `Nombre`,`_directivo`.`_Empresa` AS `_Empresa`,`_directivo`.`_Directivo` AS `_Directivo`,`_directivo`.`_Auditor` AS `_Auditor`,`_directivo`.`_Financiera` AS `_Financiera`,`_directivo`.`_Sicav` AS `_Sicav`,`_directivo`.`_Slp` AS `_Slp`,`_directivo`.`T_Relations` AS `T_Relations`,`_directivo`.`ia_suspicius` AS `ia_suspicius` from ((`ia_data_unique` left join `borme_keys` `_Empresa` on((convert(`ia_data_unique`.`Empresa_key` using utf8) = `_Empresa`.`_key`))) left join `borme_keys` `_directivo` on((convert(`ia_data_unique`.`Relation_key` using utf8) = `_directivo`.`_key`))) order by `ia_data_unique`.`Relation_key` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-04-25  0:51:27
